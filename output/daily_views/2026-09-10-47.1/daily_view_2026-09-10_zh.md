...
### [翻译失败] Line 1 - Taking stock

**☀️ 高階表達:** [翻译失败] The ability in times of hardship to concentrating on eradicating the negative factors that have led to oppression. Realizing that negative thoughts have to be eradicated.

**🌑 低階表達:** [翻译失败] The delusion of seeing oppression as an exclusively external phenomenon with often disastrous results. The sense that the world is against you.
