...
### [翻译失败] Line 6 - Application

**☀️ 高階表達:** [翻译失败] Actions which match the words and thus guarantees success. Leadership whose expression and action must be one and the same.

**🌑 低階表達:** [翻译失败] A superficiality in application that borders on hypocrisy and is justifiably treated accordingly. The hypocrisy according to leading in words but not action.
