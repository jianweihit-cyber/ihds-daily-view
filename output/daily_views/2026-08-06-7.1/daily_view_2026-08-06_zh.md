...
### [翻译失败] Line 1 - Authoritarian

**☀️ 高階表達:** [翻译失败] Venus exalted, as in the basic values and rules imposed on a child. The capacity of the Self to guide with authority.

**🌑 低階表達:** [翻译失败] The distorted intellect that believes only it knows best. The capacity of the Self to insist that its authority is best.
