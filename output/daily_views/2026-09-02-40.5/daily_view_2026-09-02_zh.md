...
### [翻译失败] Line 5 - Rigidity

**☀️ 高階表達:** [翻译失败] The revolutionary that demands absolute victory. The power of the ego is maintained in the rejection of negative relationships.

**🌑 低階表達:** [翻译失败] A tendency in revolution to accept a certain amount of necessary deviation on the assumption that it can be successfully purged later. The weakness of the ego in its loneliness to maintain and not reject negative relationships.
