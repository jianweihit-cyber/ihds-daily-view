...
**☀️ Exaltation:** The uncompromizing drive to assimilate. The drive to contribute and be an example to and for others.

**🌑 Detriment:** In a group where limitation is transcended, reason alone cannot predict individual worth. As an example, the acknowledged leader of an athletic team is not necessarily the most talented. A gift for contribution that is not conditioned by limitations.
