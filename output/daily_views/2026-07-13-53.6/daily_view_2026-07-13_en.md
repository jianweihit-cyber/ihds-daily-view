...
### Left Angle Cross of Cycles | Godhead - Parvati
...
**☀️ Exaltation:** The successful utilization of the completion of a stage in development, that by its evident success and value can be used as an example to attract support for the next stage. The energy to attract support for beginnings based on the success of the past.

**🌑 Detriment:** A tendency in this position, to hide success, in the perverse fear that the success will either create excessive demands or supporters of the original process will end their support upon completion. The pressure to hide beginnings in fear of losing past support.
